...
// if a is odd then it will be 0 if it is even it will be 1
void solve() {
    int a, b, x, y, s;
    cin >> a >> b >> x >> y;
    
    if(a > b + 1) cout << -1 << endl;
    else if(a == b + 1 && a % 2 == 1) cout << y << endl;
    else if(a == b - 1 && a % 2 == 0) cout << min(x, y) << endl;
    else{
        if(y < x){
            if((b - a) % 2 == 0) cout << (x + y) * ((b - a) / 2);
            else if(a % 2 == 0) cout << y * ((b - a) / 2) + x * ((b - a) / 2) + y; 
            else cout << y * ((b - a) / 2) + x * ((b - a) / 2) + x; 
            cout << endl;
        }
