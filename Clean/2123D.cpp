...
// Bob will win if he can get in an infinite cycle
// of undoing what Alice has done
// this means he will win if after any given replacement
// of 0's, there are k 0's in a row and an extra stray
void solve() {
    int n, k;
    cin >> n >> k;
    string s;
