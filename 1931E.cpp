...
// first move Anna removes the most zeros possible
// Anna has n moves
// every move she can remove the most 0's possible (1, 4, 7)
// after n removals of the odd places of most zeroes exposed on the outside,
// on all of Sasha's turns, he can save every 0 from two numbers
// after all of Anna's moves, if Sasha has at least m + 1 digits, he has won
void solve(){
    int n, m, d, e, c, o;
    cin >> n >> m;
    priority_queue<ll> z;
